...
add wave -label clk80m 		sim:/prfx1_test03_uart_test01/sim_board/clk80m
...
add wave -label uart_cnt  sim:/prfx1_test03_uart_test01/sim_board/data_gen_inst/uart_inst/uart_cnt
...
add wave -label uart_en  sim:/prfx1_test03_uart_test01/sim_board/data_gen_inst/uart_inst/uart_en


add wave -divider data_gen
add wave -label cur_state  sim:/prfx1_test03_uart_test01/sim_board/data_gen_inst/cur_state
add wave -label uart_data_latch -radix hex  sim:/prfx1_test03_uart_test01/sim_board/data_gen_inst/uart_data_latch
add wave -label fifo_output -radix hex  sim:/prfx1_test03_uart_test01/sim_board/data_gen_inst/fifo_output
add wave -label output_cnt -radix decimal  sim:/prfx1_test03_uart_test01/sim_board/data_gen_inst/output_cnt
